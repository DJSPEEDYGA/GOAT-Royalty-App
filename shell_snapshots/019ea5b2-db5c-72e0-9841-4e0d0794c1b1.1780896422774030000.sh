...
export DISPLAY=/var/run/com.apple.launchd.m9jwphoqPu/org.xquartz:0
export GRAHAM_AUTO_SPEAK=0
export GRAHAM_EDGE_VOICE=en-GB-LibbyNeural
export GRAHAM_PERSONAL_VOICE_ID=''
export GRAHAM_SPEAK_OUTPUT='Universal Audio Thunderbolt'
export GRAHAM_SPEAK_VOICE='Flo (English (UK))'
export GRAHAM_TTS_ENGINE=edge
export GRAHAM_USE_OSCAR_VOICE=0
export GRAHAM_USE_PERSONAL_VOICE=0
export HOME=/Users/be100radio
export LANG=C.UTF-8
export LOGNAME=be100radio
export LOG_FORMAT=json
export MallocNanoZone=0
export OSLogRateLimit=64
export RUST_LOG=warn
export SHELL=/bin/zsh
export SSH_AUTH_SOCK=/var/run/com.apple.launchd.JJA1busZFm/Listeners
export TMPDIR=/var/folders/v4/c4h023px2l59lrc2p49f7csm0000gn/T/
export USER=be100radio
